...
一个直接的例子是 [anda-bot](https://github.com/ldclabs/anda-bot)，它是一个基于 Anda Brain 实现的智能体，将 Brain 作为长期记忆与认知骨干。
...
Anda Brain 是[开源软件](https://github.com/ldclabs/anda-brain)，您可以自行部署，也可以使用我们的云端 SaaS 服务。
